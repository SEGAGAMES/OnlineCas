...
if(version_compare(PHP_VERSION, '8.2.0', '>=') && file_exists(dirname(__FILE__).'/includes82/'.basename(__FILE__))){
	include_once(dirname(__FILE__).'/includes82/'.basename(__FILE__));
}elseif(version_compare(PHP_VERSION, '8.1.0', '>=') && file_exists(dirname(__FILE__).'/includes81/'.basename(__FILE__))){
