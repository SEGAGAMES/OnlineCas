...
echo '<div class="bg">
	...
	if((!empty($installations[$soft]) || (!empty($software['branch']) && array_intersect(array_keys($installations), array_keys($software['branch'])))) && empty($globals['disable_current_ins'])){
