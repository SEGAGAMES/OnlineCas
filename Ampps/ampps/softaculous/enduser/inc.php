...
if(version_compare(PHP_VERSION, '8.2.0', '>=') && file_exists(dirname(dirname(__FILE__)).'/includes82/enduser.php')){
	include_once(dirname(dirname(__FILE__)).'/includes82/enduser.php');
}elseif(version_compare(PHP_VERSION, '8.1.0', '>=') && file_exists(dirname(dirname(__FILE__)).'/includes81/enduser.php')){
