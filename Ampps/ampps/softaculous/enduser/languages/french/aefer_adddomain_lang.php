...
$l['not_allowed'] = 'Vous n\'êtes pas autorisé à ajouter un domaine';
...
// Chaînes de thème
$l['<title>'] = 'Ajouter un Domaine';
$l['add_domain'] = 'Ajouter un Domaine';
...
$l['backup_path_exp'] = 'Le chemin de sauvegarde pour vos sauvegardes faites par Softaculous par exemple, /backups';
...
$l['submit_add'] = 'Tester et Enregistrer le Domaine';
