...
$l['incompatible'] = 'Le logiciel nécessite une version supérieure de '.APP.' ! Veuillez signaler cela à l\'administrateur du serveur.';
$l['no_install'] = 'Le fichier INSTALL.XML n\'a pas pu être trouvé ! Veuillez signaler cela à l\'administrateur du serveur.';
...
$l['no_softdb'] = 'La base de données n\'a pas été soumise.';
$l['database_exists'] = 'La base de données existe déjà. Veuillez choisir un nom différent.';
$l['databaseuser_exists'] = 'L\'utilisateur de base de données existe déjà. Veuillez choisir un nom de base de données différent.';
...
$l['db_limit_crossed'] = 'Vous avez atteint le nombre maximum de bases de données que vous pouvez créer, donc l\'installation ne peut pas continuer.';
...
$l['cant_clone_dir'] = 'Le répertoire ne peut pas être cloné car il est dans le répertoire de base.';
$l['cant_connect_mysql'] = 'Impossible de se connecter à la base de données, veuillez vérifier le nom d\'utilisateur/mot de passe de votre base de données. Si vous les avez modifiés, veuillez mettre à jour les détails dans les installations Softaculous en utilisant Modifier les détails.';
$l['same_ins'] = 'Il n\'est pas possible de cloner une installation au même emplacement';
$l['ins_exists'] = 'Il semble que vous ayez déjà <b>&soft-1;</b> installé à l\'emplacement choisi';
$l['ins_recursive'] = 'Vous ne pouvez pas cloner l\'installation dans un sous-répertoire de l\'installation d\'origine';
$l['no_clone_support'] = 'Le clonage n\'est pas pris en charge pour ce script';
...
$l['no_cron_min'] = 'Aucune minute de Cron n\'a été spécifiée';
$l['no_cron_hour'] = 'Aucune heure de Cron n\'a été spécifiée';
$l['no_cron_day'] = 'Aucun jour de Cron n\'a été spécifié';
$l['no_cron_month'] = 'Aucun mois de Cron n\'a été spécifié';
$l['no_cron_weekday'] = 'Aucun jour de la semaine de Cron n\'a été spécifié';
$l['wrong_cron_min'] = 'La minute de Cron est incorrecte. Les valeurs valides sont de 0 à 59 ou <b>*</b>';
$l['wrong_cron_hour'] = 'L\'heure de Cron est incorrecte. Les valeurs valides sont de 0 à 23 ou <b>*</b>';
$l['wrong_cron_day'] = 'Le jour de Cron est incorrect. Les valeurs valides sont de 1 à 31 ou <b>*</b>';
$l['wrong_cron_month'] = 'Le mois de Cron est incorrect. Les valeurs valides sont de 1 à 12 ou <b>*</b>';
$l['wrong_cron_weekday'] = 'Le jour de la semaine de Cron est incorrect. Les valeurs valides sont de 0 à 7 ou <b>*</b>';
...
$l['overwrite_exist'] = '<b>OU</b> <br /><input type="checkbox" name="overwrite_existing" id="overwrite_existing" />&nbsp;&nbsp;<b><span style="color:#000;">Sélectionnez la case à cocher pour écraser tous les fichiers et continuer</span></b>';
$l['prog_cloning'] = 'Clonage '; // Dont remove trailing space
$l['prog_cloning_complete'] = 'Clonage terminé.';
...
$l['finishing_process'] = 'Fin du clonage';
$l['wait_note'] = '<b>REMARQUE :</b> Cela peut prendre 3-4 minutes. Veuillez ne pas quitter cette page tant que la barre de progression n\'a pas atteint 100%';
$l['no_hostname'] = 'Veuillez saisir le nom d\'hôte de votre base de données';
$l['no_dbusername'] = 'Veuillez saisir le nom d\'utilisateur de votre base de données';
$l['no_dbuserpass'] = 'Veuillez saisir le mot de passe de votre base de données';
...
$l['ins_ver'] = 'Version';
$l['ins_time'] = 'Heure de l\'installation';
$l['ins_path'] = 'Chemin';
$l['ins_url'] = 'URL';
...
$l['clone_ins'] = 'Détails de l\'installation clonée';
$l['cloneins'] = 'Cloner l\'installation';
$l['choose_protocol'] = 'Choisissez un protocole';
$l['choose_protocol_exp'] = 'Si vous avez un certificat SSL, choisissez HTTPS';
$l['cron_job'] = 'Tâche CRON';
$l['cron_job_exp'] = 'Ce script nécessite un CRON pour fonctionner. Veuillez spécifier les horaires du CRON. Si vous ne les connaissez pas, laissez-les comme ils sont !';
$l['cron_min'] = 'Min';
$l['cron_hour'] = 'Heure';
$l['cron_day'] = 'Jour';
$l['cron_month'] = 'Mois';
...
$l['datadir_exp'] = 'Ce script nécessite de stocker ses données dans un dossier non accessible via le Web. Il sera créé dans votre dossier personnel. Par exemple, si vous spécifiez <b>datadir</b>, les fichiers suivants seront créés - /home/username/<b>datadir</b>';
$l['db_name_long'] = 'Le nom de la base de données ne peut pas dépasser 7 lettres. Veuillez choisir un nom de base de données plus court.';
...
$l['in_directory_exp'] = 'Le répertoire est relatif à votre domaine et <b>ne devrait pas exister</b>. Par exemple, pour installer le script à l\'adresse http://mondomaine/dossier/, saisissez simplement <b>dossier</b>. Pour l\'installer dans http://mondomaine/, laissez ce champ vide.';
$l['database_name'] = 'Nom de la base de données';
$l['database_name_exp'] = 'Tapez le nom de la base de données à utiliser pour l\'installation';
$l['softcopy_note'] = '<b>REMARQUE</b> : Ce logiciel nécessite qu\'il soit installé à l\'aide de son propre utilitaire d\'installation. Veuillez visiter l\'URL qui sera affichée une fois les fichiers copiés pour terminer le processus d\'installation.';
$l['softsubmit'] = 'Cloner';
...
$l['clone_tweet_sub'] = 'Dites-le à vos amis';
...
$l['no_sclone'] = 'Le fichier CLONE.XML n\'a pas pu être trouvé ! Veuillez signaler cela à l\'administrateur du serveur.';
$l['no_functions'] = 'Le fichier FONCTIONS DE CLONAGE n\'a pas pu être trouvé ! Veuillez signaler cela à l\'administrateur du serveur.';

$l['clone_push_bg'] = 'Le clonage a été poussé en arrière-plan';
$l['err_mysql_db'] = 'Le nom de la base de données MySQL est incorrect car la base de données n\'a pas pu être sélectionnée.';

$l['error_max_clone_script'] = 'Vous avez atteint le nombre maximum de (<b>&soft-1;</b>) Clones autorisés par script';
...
$l['fetch_db_details'] = 'Fetch the database details automatically from your installation\'s configuration file while cloning ?';