...
$l['www_files_exist'] = 'L\'installation ne peut pas se poursuivre car les fichiers suivants existent déjà dans le répertoire WEB';
$l['no_decompress_www'] = 'Des erreurs sont survenues lors de la décompression des fichiers Web.';
$l['no_config_perl_path'] = 'Erreur survenue lors de la configuration des fichiers CGI.';
...
$l['wwwdir_invalid'] = 'Le répertoire WWW que vous avez saisi est invalide.';
...
$l['no_perl_install'] = 'PERL n\'est pas installé. Pour l\'installer, veuillez cliquer <a href="'.$globals['index'].'act=apps&app=19">ici</a>';
...
$l['in_directory_exp'] = 'Le répertoire est relatif à votre domaine et <b>ne doit pas exister</b>. par ex. Pour installer à http://mondomaine/dir/ tapez simplement <b>dir</b>. Pour installer seulement à http://mondomaine/ laissez ce champ vide.';
...
$l['wwwdir'] = 'Répertoire Web';
$l['wwwdir_exp'] = 'Un répertoire accessible via le web';
...
$l['ampps_download'] = 'Vous pouvez développer <b>&soft-1;</b> sur votre <b>ordinateur de bureau</b> en utilisant notre outil de développement gratuit Softaculous AMPPS. Cliquez <a href="https://www.ampps.com/downloads" target="_blank"><b>ici</b></a> pour télécharger <a href="https://www.ampps.com/downloads" target="_blank"><img src="https://images.softaculous.com/ampps.gif" height="25" /></a>';
...
$l['backup_location'] = 'Emplacement de la sauvegarde';
...
// Erreurs pour les paramètres de sauvegarde automatique
$l['wrong_autobackup_cron_min'] = 'La minute de sauvegarde automatique Cron est incorrecte. Les valeurs valides sont 0-59 ou un *';
$l['wrong_autobackup_cron_hour'] = 'L\'heure de sauvegarde automatique Cron est incorrecte. Les valeurs valides sont 0-23 ou un *';
$l['wrong_autobackup_cron_day'] = 'Le jour de sauvegarde automatique Cron est incorrect. Les valeurs valides sont 1-31 ou un *';
$l['wrong_autobackup_cron_month'] = 'Le mois de sauvegarde automatique Cron est incorrect. Les valeurs valides sont 1-12 ou un *';
$l['wrong_autobackup_cron_weekday'] = 'Le jour de la semaine de sauvegarde automatique Cron est incorrect. Les valeurs valides sont 0-7 ou un *';
