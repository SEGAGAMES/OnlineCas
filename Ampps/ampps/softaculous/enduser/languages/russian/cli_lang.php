...
$l['err_cannot_install_plugin'] = "Plugin installation can not be performed for this control panel.\n";
$l['err_invalid_sid'] = "Script ID is invalid.\n";
$l['err_no_plugin_support'] = "Plugin Management is not supported in this script.\n";
$l['err_empty_slug'] = "Slug is missing.\n";
$l['err_fail_install_plugin'] = "Failed to install plugin. Following errors occurred:\n";
$l['install_plugin_success'] = "Plugin installed successfully\n";
// import_webuzo.php
