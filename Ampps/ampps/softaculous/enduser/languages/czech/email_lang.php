...
$l['off_email_link'] = 'Nastavení e-mailu je zakázáno správcem';
...
$l['done'] = 'Hotovo';
$l['email_password_user'] = 'E-mailové heslo v plain textu';
$l['email_password_user_exp'] = 'Při zaškrtnutí budou hesla pro účely instalace, klonování apod. zasílána e-mailem v plain textu ';
$l['import_email'] = 'Importovat e-maily'; 
$l['import_email_exp'] = 'Odesílat e-maily s podrobnostmi ohledně importovaných instalací';

$l['staging_email'] = 'Stagování e-mailů';
$l['staging_email_exp'] = 'Odeslat e-mail obsahující podrobnosti instalace po vytvoření stag prostředí jakékoliv instalace'; 