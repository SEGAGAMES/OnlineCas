...
$l['off_email_link'] = 'Nastavenie e-mailu je zakázané správcom';
...
$l['done'] = 'Hotovo';
$l['email_password_user'] = 'E-mailové heslo v plain texte';
$l['email_password_user_exp'] = 'Pri zaškrtnutí budú heslá pre účely inštalácie, klonovania apod. zasielané e-mailom v plain texte ';
$l['import_email'] = 'Importovať e-maily'; 
$l['import_email_exp'] = 'Odosielať e-maily s podrobnosťami ohľadom importovaných inštalácií'; 

$l['staging_email'] = 'Stagovanie e-mailov';
$l['staging_email_exp'] = 'Odoslať e-mail obsahujúci podrobnosti inštalácie po vytvorení stag prostredia akejkoľvek inštalácie';