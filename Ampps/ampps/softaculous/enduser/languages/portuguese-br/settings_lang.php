...
$l['exp_lang'] = 'Selecione o idioma pré-definido';
...
$l['disable_suggestions'] = 'Desativar '.APP.' Sugestões de Recurso';
$l['exp_disable_suggestions'] = 'Isto irá desativar as mensagens do '.APP.' com sugestões de recurso';
$l['reset'] = 'Resetar';
...
$l['exp_off_backup_au'] = 'Se selecionado, os backups não serão gerados antes de atualizar instalações, plugins e temas. Importante: Certifique-se de ter backups completo e íntegro para restauração, caso a atualização venha a falhar.';

$l['backup_proto'] = 'Protocolo';
$l['backup_ftp'] = 'FTP';
