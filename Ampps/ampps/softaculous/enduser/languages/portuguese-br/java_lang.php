...
$l['java_message'] = 'Java não instalado. Instale clicando <a href="'.$globals['index'].'act=apps&app=37">aqui</a>';
$l['java_title'] = 'Java não está instalado no seu servidor';
...
$l['db_name_long'] = 'O nome do banco de dados não pode ter mais de 7 letras. Por favor, escolha um nome de banco de dados mais curto.';
...
$l['mail_pass'] = 'Senha do Admin';
$l['mail_db'] = 'Banco de dados MySQL';
$l['mail_dbuser'] = 'Usuário MySQL';
$l['mail_dbhost'] = 'Host MySQL';
$l['mail_dbpass'] = 'Senha MySQL';
...
$l['no_dir'] = 'Informe o nome do diretório.';
...
$l['not_java_script'] = 'Este script não é Java';
...
$l['sel_version'] = 'Selecione a Versão';
$l['choose_version_exp'] = 'Escolha a versão a ser instalada.';
$l['choose_version'] = 'Escolha a versão que deseja instalar';
$l['select'] = 'Selecione';
...
$l['no_java_support'] = 'A instalação de Java Script não é suportada neste painel';
