...
$l['ins_recursive'] = 'Você não pode criar uma ambiente de testes em um subdiretório da instalação original';
...
$l['prog_staging'] = 'Criando Ambiente de Testes '; // Dont remove trailing space
$l['prog_staging_complete'] = 'Criação do Ambiente de Testes Concluído.';
...
$l['finishing_process'] = 'Finalizando Criação do Ambiente';
...
//Theme Strings
$l['<title>'] = APP.' - Ambiente de Testes';
$l['info'] = 'Detalhes';
...
$l['softsubmit'] = 'Clonar';
$l['congrats'] = 'Parabéns, ambiente de testes criado com sucesso';
$l['succesful'] = 'Ambiente de testes foi criado com sucesso em';
...
$l['staging_tweet_sub'] = 'Conte aos seus amigos';
...
$l['staging_push_bg'] = 'O processo de criação de ambiente está sendo executado em segundo plan';
$l['err_mysql_db'] = 'O nome do banco de dados MySQL está incorreto, pois o banco de dados não pôde ser selecionado.';

$l['max_staging_error'] = 'Você atingiu o limite de (<b>&soft-1;</b>) Ambientes de Testes permitido. Exclua Ambientes de Testes indesejados para poder criar um novo.';

$l['error_max_staging_script'] = 'Você atingiu o limite de (<b>&soft-1;</b>) Ambientes de Testes permitido pelo software';
...
$l['fetch_db_details'] = 'Permitir que o Softaculous obtenha os detalhes do banco de dados da sua instalação durante a preparação?';