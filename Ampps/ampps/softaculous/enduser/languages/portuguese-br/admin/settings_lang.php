...
$l['no_lang'] = 'Nenhum idioma selecionado';
...
$l['force_auto_upgrade_exp'] = 'Chosen auto upgrade preference, will be selected and disabled in the enduser panel. Enduser(s) will <b>not</b> be able to modify it. (Applicable for new as well as existing installations)';
...
$l['sync_domains_exp_remote'] = 'This will enable the synchronizing of Domain(s) in '.APP.' records with the domain(s) list passed via $PRE_LOGIN in session.php, click <a href="http://www.softaculous.com/docs/Softaculous_Remote#sync-domains" target="_blank">here</a> to for guide';
$l['sync_domains_exp_ent'] = 'This will enable the synchronizing of Domain(s) in '.APP.' records with the domain(s) list passed via $PRE_LOGIN in session.php, click <a href="http://www.softaculous.com/docs/Softaculous_Enterprise_Integration#sync-domains" target="_blank">here</a> to for guide';
...
$l['auto_backup'] = 'Frequência Padrão para o Backup Automático';
...
$l['off_backup_au'] = 'Desabilitar backups antes da atualização automática';
...
$l['host_sm_exp'] = 'You can create a CNAME record to point to <a href="https://sitepad.com/docs/admin-old/servers/" target="_blank">our Servers</a>. Or you can simply use our servers hostname. If empty SitePad will use default server host for user';
