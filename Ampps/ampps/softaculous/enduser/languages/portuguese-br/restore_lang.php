...
$l['restore_delete_files_exp'] = 'Se marcado, os arquivos/pastas existentes serão excluídos e os arquivos de backup serão restaurados. <br /><b>Importante</b>: Certifique-se de escolher Backup completo ao criar este backup.';
$l['no_restore_file_param'] = 'O nome do arquivo de backup não foi informado. É necessário para iniciar o processo de restauração.';