...
$l['err_max_insid_backups'] = 'Você atingiu o limite de (<b>&soft-1;</b>) backups permitidos nesta instalação. Exclua os backups indesejados desta instalação para poder fazer um novo backup.';
$l['err_max_local_insid_backups'] = 'Você atingiu o limite de (<b>&soft-1;</b>) backups local permitidos nesta instalação. Exclua os backups indesejados desta instalação no servidor local para poder fazer um novo backup.';
...
$l['incorrect_offset'] = 'Offset incorreto';
...
$l['rbackup_disabled'] = 'O backup remoto está desativado pelo Administrador.';
$l['rbackup_protocol_disabled'] = 'Backup em <b>&soft-1;</b> está desativado pelo Administrador';

$l['onedrive_err_end'] = 'Ocorreram alguns erros ao enviar o backup para sua conta do OneDrive!';
$l['onedrive_err_upload_url'] = 'Falha ao gerar a URL de upload do OneDrive';

$l['dropbox_refresh_token_err'] = 'Falha ao gerar o token de acesso do Dropbox. Por favor, autorize novamente o local do Dropbox no menu Configurações -> Editar local de backup.';