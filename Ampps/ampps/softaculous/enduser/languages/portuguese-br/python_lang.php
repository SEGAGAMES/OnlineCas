...
$l['python_message'] = 'Python não instalado. Instale clicando <a href="'.$globals['index'].'act=apps&app=29">aqui</a>';
$l['python_title'] = 'Python não está instalado no seu servidor';
...
$l['not_python_script'] = 'Este não é um script de linguagem Python';
