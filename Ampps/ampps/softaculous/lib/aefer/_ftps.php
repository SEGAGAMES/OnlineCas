...
class ftps{
	...
	function utime($pathname, $mtime) {
		return @ftp_site($this->ftp_conn, sprintf("UTIME %d %s", $mtime, $pathname)); // Try to set the mtime if UTIME command is supported by FTP
	}
