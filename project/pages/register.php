    ...
    <div class="register-form">
        <form method="POST" action="">
            <div class="form-group">
                <label for="reg-name">Фамилия:</label>
                <input type="text" id="reg-name" name="surname" required>
            </div>
            ...
            <div class="form-group">
                <label for="reg-name">Отчество (если есть):</label>
                <input type="text" id="reg-name" name="lastname">
            </div>
