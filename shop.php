...
<div class="shop-grid">
    <div class="product-card">
        <div class="product-image">
            <img src="pages/AVE/Аватарка2.jpg" alt="Аватарка" class="circle-image">
        </div>
    ...
    <div class="product-card">
        <div class="product-image">
            <img src="pages/AVE/Аватарка 3.png" alt="pages/AVE/Аватарка2.jpg" class="circle-image">
        </div>
        <div class="product-content">
    ...
    <div class="product-card">
        <div class="product-image">
            <img src="pages/AVE/Аватарка4.jpg" alt="pages/AVE/Аватарка2.jpg" class="circle-image">
        </div>
        <div class="product-content">
    ...
    <div class="product-card">
        <div class="product-image">
            <img src="pages/AVE/Premium.png" alt="Эксклюзивная аватарка" class="circle-image">
        </div>
        <div class="product-content">
